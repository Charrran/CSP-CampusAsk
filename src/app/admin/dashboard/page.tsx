      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-500/10 via-violet-500/5 to-transparent border border-violet-500/10 p-6 lg:p-8">
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground mt-1 max-w-lg">
            Manage users, subjects, and moderate platform activity from your
            admin dashboard.
          </p>
        ...
        <div className="absolute -top-16 -right-16 w-48 h-48 bg-violet-500/5 rounded-full blur-2xl" />
      </div>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1 max-w-sm">
              User registrations, moderation actions, and system events will
