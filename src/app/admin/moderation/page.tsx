    ...
    <div className="flex flex-col min-h-full">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
        <div>
          ...
          <p className="font-body text-[#605850] mt-2 max-w-md">Oversee community integrity and review flagged inquiries within CampusAsk.</p>
        </div>
        ...
        <div className="bg-[#f6f0e8] p-8 rounded-xl shadow-[0_2px_16px_rgba(58,48,42,0.04)] border border-outline-variant/30 col-span-1 md:col-span-2 relative overflow-hidden group hover:shadow-md transition-shadow">
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-8 sm:gap-12">
              <div>
                <p className="font-label text-xs uppercase tracking-widest text-[#605850] mb-1 font-bold">Flagged Doubts</p>
              ...
              <div>
                <p className="font-label text-xs uppercase tracking-widest text-[#605850] mb-1 font-bold">Flagged Answers</p>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#f2ece4] border-b border-outline-variant/40">
                <th className="px-8 py-4 font-label text-xs uppercase tracking-widest text-[#605850] font-bold">Details</th>
                <th className="px-8 py-4 font-label text-xs uppercase tracking-widest text-[#605850] font-bold">Reporter</th>
                <th className="px-8 py-4 font-label text-xs uppercase tracking-widest text-[#605850] font-bold">Reason</th>
                <th className="px-8 py-4 font-label text-xs uppercase tracking-widest text-[#605850] font-bold">Type</th>
                <th className="px-8 py-4 font-label text-xs uppercase tracking-widest text-[#605850] font-bold text-right">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-outline-variant/30">
              {items.map((item) => (
                <tr key={`${item.type}-${item.id}`} className="hover:bg-[#f6f0e8] transition-colors group">
                  <td className="px-8 py-6 max-w-xs">
                    ...
                    <p className="font-body text-xs text-[#605850] mt-1 font-medium">ID: #{item.id} | {item.time}</p>
                  </td>
              ...
              {!items.length && (
                <tr>
                  <td colSpan={5} className="px-8 py-12 text-center text-[#605850] font-medium">
